    ...
    private void BotaoConfirmaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BotaoConfirmaActionPerformed
        try {
            ...
            if (this.InserirDesc.getText().length() < 2) {
                throw new Mensagens("Descri̤̣o deve conter ao menos 2 caracteres.");
            } else {
                descricao = this.InserirDesc.getText();
            }
            if (this.QuantEstoque.getText().length() <= 0) {
                throw new Mensagens("Qauntidade em estoque deve ser n̼mero e maior que zero.");
            } else {
                quant_estoque = Integer.parseInt(this.QuantEstoque.getText());
            }
            if (this.Preco.getText().length() <= 0.0) {
                throw new Mensagens("Pre̤o deve ser n̼mero e maior que zero.");
            } else {
            ...
            if (this.RegiaoVinho.getText().length() < 2) {
                throw new Mensagens("Regịo deve conter ao menos 2 caracteres.");
            } else {
            ...
            JOptionPane.showMessageDialog(null, "Erro ao converter n̼mero.");
